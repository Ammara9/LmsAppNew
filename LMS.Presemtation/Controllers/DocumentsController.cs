...
namespace LMS.Presemtation.Controllers
{
    ...
    public class DocumentsController : ControllerBase
    {
        ...
        )
        {
            ...
            var documentDto = documents.Select(p => new DocumentDto
            {
        ...
        public async Task<ActionResult<DocumentDto>> PostDocument(int moduleId, [FromForm] DocumentUploadDto documentDto)
        {
            ...
            if (string.IsNullOrEmpty(documentDto.File.Name))
            {
            ...
            var filePath = Path.Combine(_environment.WebRootPath, uploadsDirectory, documentDto.File.Name);
